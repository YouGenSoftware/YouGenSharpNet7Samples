...
public partial class Northwind_HydratedStaticIndirectReferenceTransformerModels : Northwind_HydratedStaticIndirectReferenceTransformerModelsBase
{
	public Northwind_dbo_Order_Details_Extended_IR GetHydratedStaticNorthwind_dbo_Order_Details_Extended_IR(Boolean fillPrimaryKey = false)
	{
		...
		retObj.ProductName = "x08facdnUBECSDYmuBAg2IYPBvsK647cMDLnUIKG";
		retObj.UnitPrice = (0.07924926209598437M);
		retObj.Quantity = (14743);
		retObj.Discount = (0.21721286F);
		retObj.ExtendedPrice = (0.3117937226581131M);
		return retObj;
	}
}
