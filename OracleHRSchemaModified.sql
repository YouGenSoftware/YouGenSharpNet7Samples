--------------------------------------------------------
--  File created - Wednesday-March-08-2023   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE "HR"."PACKAGE1" AS 

    PROCEDURE OPEN_ONE_CURSOR (N_EMPNO IN NUMBER,
                               IO_CURSOR OUT SYS_REFCURSOR);
    PROCEDURE OPEN_TWO_CURSORS (EMPCURSOR OUT SYS_REFCURSOR,
                                DEPTCURSOR OUT SYS_REFCURSOR);  
    PROCEDURE ReturnStringProc (VAR_INPUT IN INTEGER,
                                CONVERTED_TO_VARCHAR2 OUT VARCHAR2);
    PROCEDURE ParamOutCursors (VAR_INPUT IN INTEGER,
                                var_date_input IN DATE,
                                CONVERTED_TO_VARCHAR2 OUT VARCHAR2,
                                EMPCURSOR OUT SYS_REFCURSOR,
                                DEPTCURSOR OUT SYS_REFCURSOR);
    FUNCTION FUNCConvertDecimalToVarchar (VAR_INPUT IN INTEGER)
                                    RETURN VARCHAR2;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "HR"."PACKAGE1" AS
  ...
  PROCEDURE OPEN_ONE_CURSOR (N_EMPNO IN NUMBER,  
    ...
    IS
    BEGIN
        OPEN EMPCURSOR FOR SELECT * FROM EMPLOYEES; 
        OPEN DEPTCURSOR FOR SELECT * FROM DEPARTMENTS;
    ...
    AS
    BEGIN
        SELECT to_char(VAR_INPUT) INTO CONVERTED_TO_VARCHAR2 from dual;
    END;
    PROCEDURE ParamOutCursors (VAR_INPUT IN INTEGER,
                                var_date_input IN DATE,
                                CONVERTED_TO_VARCHAR2 OUT VARCHAR2,
    ...
    begin
        ...
        SELECT * 
        FROM JOB_HISTORY
        WHERE EMPLOYEE_ID = TO_NUMBER(VAR_INPUT)
        AND START_DATE = var_date_input; 
    ...
    ret_ VARCHAR2(128);
    BEGIN
    SELECT TO_CHAR(VAR_INPUT) INTO ret_ FROM DUAL;
        RETURN ret_;    
    END;
...
/
--------------------------------------------------------
--  DDL for Function HR_FUNCTION_1
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "HR"."HR_FUNCTION_1" 
(
  PARAM1_IN_NUMBER IN NUMBER DEFAULT 2 
, PARAM2_OUT_VARCHAR OUT VARCHAR2
, PARAM3_IN_DATE IN DATE 
) RETURN VARCHAR2 AS 
BEGIN
  RETURN 'OH NOES';
END HR_FUNCTION_1;
...
/
--------------------------------------------------------
--  DDL for Function HR_FUNCTION_2
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "HR"."HR_FUNCTION_2" 
(
  PARAM1_IN_NUMBER IN NUMBER DEFAULT 2 
, PARAM2_OUT_VARCHAR OUT VARCHAR2
, PARAM3_IN_DATE IN DATE 
) RETURN SYS_REFCURSOR AS
curtype SYS_REFCURSOR;
BEGIN
  OPEN curtype FOR
