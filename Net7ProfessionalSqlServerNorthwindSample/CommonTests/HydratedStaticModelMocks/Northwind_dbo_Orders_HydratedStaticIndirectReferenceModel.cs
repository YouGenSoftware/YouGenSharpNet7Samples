...
public partial class Northwind_HydratedStaticIndirectReferenceTransformerModels : Northwind_HydratedStaticIndirectReferenceTransformerModelsBase
{
	public Northwind_dbo_Orders_IR GetHydratedStaticNorthwind_dbo_Orders_IR(Boolean fillPrimaryKey = false)
	{
		...
		retObj.CustomerID = "9lnMY";
		retObj.EmployeeID_IR = _encryptionDecryptionService!.EncInt32Nullable(Convert.ToInt32(1));
		retObj.OrderDate = DateTime.Parse("12/4/2021 12:00:00 AM");
		retObj.RequiredDate = DateTime.Parse("11/25/2009 12:00:00 AM");
		retObj.ShippedDate = DateTime.Parse("9/7/2016 12:00:00 AM");
		retObj.ShipVia_IR = _encryptionDecryptionService!.EncInt32Nullable(Convert.ToInt32(1));
		retObj.Freight = (0.037389604102901486M);
		retObj.ShipName = "rRpiaP05bVEOaa1zCjhjc jNSXjx83dBvBz4ur0z";
		retObj.ShipAddress = "c4754qXC9IGmTIuwItztjxbZoB0NOYCNvEk0Uc1SwHeUqQUsQyIMtXi0tvKT";
		retObj.ShipCity = "asFvwUNjcQfkvgy";
		retObj.ShipRegion = " HON3idGGj6lV8c";
		retObj.ShipPostalCode = "jmFWE3Inw9";
		retObj.ShipCountry = "HE38iQKwdMMeZVI";
